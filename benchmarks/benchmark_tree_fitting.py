...
def test_arbitrary_trees_all_mutations_have_sample(
    n_burnin_iter=10, n_mutations=10
):
    # given
    ...
    # set GLs to het for every mutation of the sample and to hom ref for
    # all other mutations
...
def test_arbitrary_trees_leaves_have_sample(n_burnin_iter=10, n_mutations=10):
    ...
    # set GLs to het for every mutation of the sample and to hom ref for all
    # other mutations
...
if __name__ == "__main__":
    ...
    for setup_string in [
        ...
        (
            "test_arbitrary_trees_all_mutations_have_sample("
            "n_mutations={mutations})"
        ),
    ]:
        print(f"Testing {setup_string}")
        for number, mutations in [
            (10, 100),
            (10, 300),
            (10, 1000),
            (10, 3000),
